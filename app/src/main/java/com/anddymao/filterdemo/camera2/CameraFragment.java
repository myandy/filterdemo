package com.anddymao.filterdemo.camera2;
...
import com.anddymao.filterdemo.adapter.FilterAdapter;
import com.anddymao.filterdemo.filter.FilterFactory;
import com.anddymao.filterdemo.filter.FilterItem;
import com.anddymao.filterdemo.filterlibrary.FilterSDK;
import com.anddymao.filterdemo.filterlibrary.base.GPUImageFilter;
import com.anddymao.filterdemo.utils.SaveUtils;
import com.anddymao.filterdemo.view.CameraSurfaceView;
...
import static com.anddymao.filterdemo.camera2.CameraFragment.CameraRatio.FULL_SCREEN;
import static com.anddymao.filterdemo.camera2.CameraFragment.CameraRatio.WIDTH_HEIGHT_3_4;
...
public class CameraFragment extends Fragment
    ...
    private CameraRatio mCameraRatio = WIDTH_HEIGHT_3_4;

    public enum CameraRatio {
        FULL_SCREEN, WIDTH_HEIGHT_3_4, WIDTH_HEIGHT_1_1
    }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.btn_swap_camera).setOnClickListener(this);
        mCameraSurfaceView = view.findViewById(R.id.surface_view);
        mRecyclerView = view.findViewById(R.id.recycler_view);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        linearLayoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
        mRecyclerView.setLayoutManager(linearLayoutManager);
        mAdapter = new FilterAdapter(getContext(), FilterFactory.getPortraitFilterItem());
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnFilterChangeListener(onFilterChangeListener);

        Point screenSize = new Point();
        getActivity().getWindowManager().getDefaultDisplay().getSize(screenSize);
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mCameraSurfaceView.getLayoutParams();
    ...
    private void setUpCameraOutputs() {
        ...
        try {
            ...
            if (mCameraRatio == FULL_SCREEN) {
                rotatedPreviewHeight = displaySize.y;
            } else if (mCameraRatio == WIDTH_HEIGHT_3_4) {
                rotatedPreviewHeight = (rotatedPreviewWidth * 4) / 3;
            } else {
...
//            }
            ...
            mPreviewSize = chooseOptimalSize(map.getOutputSizes(SurfaceTexture.class),
                    rotatedPreviewWidth, rotatedPreviewHeight, rotatedPreviewWidth,
